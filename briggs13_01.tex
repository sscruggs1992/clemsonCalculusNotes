...
\section{13.1: Vectors and the Geometry of Space}
  ...
  \end{center}
  \begin{ex*}
    Let $\bfu=\bracket{1,2}$, $\bfv=\bracket{-2,3}$, $c=2$, and $d=3$. Find the following:
    \begin{tasks}[after-item-skip=20pt, label=](2)
      \task $\bfu+\bfv$
      \task $c\bfu$
      \task $c\bfu+d\bfv$
      \task $\bfu-c\bfv$
  ...
  \end{defn*}
  \begin{ex*}
    Let $\bfu=\bracket{-7,3}$. Find two unit vectors parallel to $\bfu$. Find another vector parallel to $\bfu$ with a magnitude of $2$.
  \end{ex*}
  \vspace*{\stretch{1}}
  \pagebreak
