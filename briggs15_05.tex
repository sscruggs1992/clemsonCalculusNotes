...
\section{15.5: Directional Derivatives and the Gradient}
  ...
  \begin{ex*}
    Consider $f(x,y)=x^2+2y^2+4z^2-1$ and the level surface $f(x,y,z)=3$. Find the gradient and the corresponding rate of change at the points $P(2,0,0)$, $Q(0,\sqrt{2},0)$, $R(0,0,1)$, and $S(1,1,1/2)$ on the level surface.
  \end{ex*}
