...
\section{15.4: The Chain Rule}
  ...
  \begin{thmBox*}[Theorem 15.7: Chain Rule (One Independent Variable)]
  ...
  \begin{thmBox*}[Theorem 15.8: Chain Rule (Two Independent Variables)]
  ...
  \begin{thmBox*}[Theorem 15.9: Implicit Differentiation]
