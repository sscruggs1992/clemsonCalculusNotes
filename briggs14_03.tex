...
\section{14.3: Motion in Space}
  ...
  \begin{ex*}
    Consider a ball with an initial position of $\bracket{x_0,y_0}=\bracket{0,3}\ m$ and an initial velocity of $\bracket{u_0,v_0}=\bracket{25,4}\ m/s$.
  \end{ex*}
  \begin{tasks}[after-item-skip=\stretch{1}](1)
...
%  \pagebreak
  ...
  \begin{tasks}[after-item-skip=\stretch{1}, resume](1)
    \task Assuming the ground is flat and level, how far does the ball travel horizontally? 
