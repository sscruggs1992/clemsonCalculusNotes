...
\section{2.6: Continuity}
  ...
  \begin{thmBox*}[Theorem 2.10: Polynomial and Rational Functions]
  ...
  \begin{thmBox*}[Theorem 2.11: Continuity of Composite Functions at a Point]
    If $g$ is continuous at $a$ and $f$ is continuous at $g(a)$, then the composite function $f\circ g$ is continuous at $a$.
  \end{thmBox*}

  \begin{thmBox*}[Theorem 2.12: Limits of Composite Functions]
    \begin{enumerate}
  ...
  \begin{thmBox*}[Theorem 2.13: Continuity of Functions with Roots]
  ...
  \begin{thmBox*}[Theorem 2.14: Continuity of Inverse Functions]
  ...
  \vspace*{15pt}
  \begin{thmBox*}[Theorem 2.15: Continuity of Transcendental Functions]
  ...
  \begin{thmBox*}[Theorem 2.16: Intermediate Value Theorem]
