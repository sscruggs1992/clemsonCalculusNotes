...
\section{3.9: Derivatives of Logarithmic and Exponential Functions}
  Recall that $y=\log_a(x)$ and $y=a^x$ are inverse functions:
    ...
    \begin{minipage}{0.65\linewidth}
      \begin{thmBox*}[Inverse Properites of $a^x$ and $\log_a(x)$]
        \begin{enumerate}
  ...
  \begin{thmBox*}[Theorem 3.15: Derivative of $\ln(x)$.]
  ...
  \begin{thmBox*}[Theorem 3.16: Derivative of $b^x$.]
    If $b>0$ and $b\neq 1$, then for all $x$.
  ...
  \begin{thmBox*}[Theorem 3.18: Derivative of $\log_b(x)$.]
    If $b>0$ and $b\neq 1$, then
  ...
  \vspace*{\stretch{1}}
  \setlength{\jot}{10pt}
  \begin{thmBox*}[Derivative rules for exponential functions:]
    \begin{align*}
      \hspace*{-10pt}
  ...
  \begin{thmBox*}[Derivative rules for logarithmic functions:]
    \begin{align*}
      \hspace*{-10pt}
