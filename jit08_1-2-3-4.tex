...
\section{JIT 8.2: Logs as Inverses of Exponential Functions}
  ...
  \begin{thmBox*}[Inverse Relations for Exponential and Logarithmic Functions]
...
\section{JIT 8.4: The Natural Logarithm}
  ...
  \begin{minipage}{0.275\linewidth}
    ...
    \end{flushright}
  \end{minipage}
  \begin{thmBox*}[Inverse Properties for $a^x$ and $\log_a x$]
    \begin{center}
  ...
  \begin{ex*}
    ...
    \begin{minipage}{0.45\linewidth}
      \begin{flushright}
        \begin{thmBox*}[Laws of the Natural Logarithm]
          For $x,y>0$:
            \begin{enumerate}
